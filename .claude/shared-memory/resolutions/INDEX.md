...
| R-009 | Import Claude Design → port 19/19 màn thành v2, user duyệt, xoá sạch UI v1 | `flutter`, `design-import`, `claude-design`, `ui-migration`, `v2`, `delete-old-ui`, `aurora-gradient`, `vibe-check`, `onboarding`, `google-fonts`, `negative-margin`, `phone-frame`, `viewport-meta` | web, android, ios | major | 2026-09-02 | user | [R-009-v2-design-full-migration-and-v1-removal.md](R-009-v2-design-full-migration-and-v1-removal.md) |
| R-010 | Deploy v2 xong vẫn hiện UI v1 — nginx gắn `immutable, max-age=30d` lên main.dart.js (Flutter không hash tên file), Cloudflare edge giữ bản cũ | `cloudflare`, `cdn`, `cache`, `edge-cache`, `purge-cache`, `cloudflare-tunnel`, `nginx`, `cache-control`, `immutable`, `flutter-web`, `stale-deploy`, `cf-cache-status` | web | major | 2026-09-02 | user | [R-010-cloudflare-edge-cache-stale-flutter-bundle.md](R-010-cloudflare-edge-cache-stale-flutter-bundle.md) |
