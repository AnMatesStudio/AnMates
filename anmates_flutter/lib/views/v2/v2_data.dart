...
class Mate {
  const Mate({
    ...
    this.age, this.avatarUrl, this.avatarAsset,
  });

  /// A bundled illustration, for the sample profiles.
...
/// and swiped locally: an invite to one never reaches the API. Their avatars
/// are flat illustrations (assets/v2/avatars), never photos of real people.
const List<Mate> kSampleMates = [
  Mate(userId: 'sample-1', avatarAsset: 'assets/v2/avatars/sample-1.png',
      name: 'Minh Anh', age: 24, img: A.hotpot, match: 92,
      overlapFoods: ['lau', 'oc'], tags: ['Đi ăn khuya', 'Quán vỉa hè', 'Hướng nội']),
  Mate(userId: 'sample-2', avatarAsset: 'assets/v2/avatars/sample-2.png',
      name: 'Hoàng Nam', age: 27, img: A.bbq, match: 88,
      overlapFoods: ['nuong', 'bia'], tags: ['BBQ Hàn', 'Nhậu nhẹ', 'Vui vẻ']),
  Mate(userId: 'sample-3', avatarAsset: 'assets/v2/avatars/sample-3.png',
      name: 'Thu Trang', age: 22, img: A.coffee, match: 85,
      overlapFoods: ['cafe', 'trang_mieng'], tags: ['Cà phê sáng', 'Chụp ảnh món', 'Healthy']),
  Mate(userId: 'sample-4', avatarAsset: 'assets/v2/avatars/sample-4.png',
      name: 'Quốc Bảo', age: 30, img: A.ramen, match: 81,
      overlapFoods: ['pho', 'lau'], tags: ['Sành phở', 'Ăn sáng sớm', 'Ít nói']),
  Mate(userId: 'sample-5', avatarAsset: 'assets/v2/avatars/sample-5.png',
      name: 'Ngọc Hân', age: 25, img: A.beer, match: 79,
      overlapFoods: ['oc', 'nuong'], tags: ['Mê hải sản', 'Đi nhóm', 'Hay cười']),
  Mate(userId: 'sample-6', avatarAsset: 'assets/v2/avatars/sample-6.png',
      name: 'Đức Huy', age: 28, img: A.bbq, match: 76,
      overlapFoods: ['nuong', 'pho'], tags: ['Gym xong đi ăn', 'Ăn khỏe', 'Đúng giờ']),
  Mate(userId: 'sample-7', avatarAsset: 'assets/v2/avatars/sample-7.png',
      name: 'Lan Chi', age: 23, img: A.hotpot, match: 74,
      overlapFoods: ['lau', 'cafe'], tags: ['Lẩu Thái', 'Cuối tuần', 'Thử quán mới']),
  Mate(userId: 'sample-8', avatarAsset: 'assets/v2/avatars/sample-8.png',
      name: 'Tuấn Kiệt', age: 26, img: A.beer, match: 71,
      overlapFoods: ['oc', 'banh_mi'], tags: ['Ốc đêm', 'Bóng đá', 'Nói nhiều']),
  Mate(userId: 'sample-9', avatarAsset: 'assets/v2/avatars/sample-9.png',
      name: 'Bảo Ngọc', age: 29, img: A.coffee, match: 68,
      overlapFoods: ['trang_mieng', 'cafe'], tags: ['Hảo ngọt', 'Chè & bánh', 'Chill']),
  Mate(userId: 'sample-10', avatarAsset: 'assets/v2/avatars/sample-10.png',
      name: 'Gia Hưng', age: 31, img: A.ramen, match: 65,
